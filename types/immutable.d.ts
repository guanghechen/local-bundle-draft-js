...
export declare namespace Immutable {
   ...
   */
  export function fromJS(json: any, reviver?: (k: any, v: Iterable<any, any>) => any): any
  ...
  export interface List<T> extends Collection.Indexed<T> {
     ...
     * @see `Map#merge`
     */
    merge(...iterables: Array<Iterable.Indexed<T>>): List<T>
    ...
    mergeWith(
      ...
      ...iterables: Array<Iterable.Indexed<T>>
    ): List<T>
    mergeWith(merger: (previous?: T, next?: T, key?: number) => T, ...iterables: T[][]): List<T>

    /**
     * @see `Map#mergeDeep`
     */
    mergeDeep(...iterables: Array<Iterable.Indexed<T>>): List<T>
    ...
    mergeDeepWith(merger: (previous?: T, next?: T, key?: number) => T, ...iterables: T[][]): List<T>
     ...
     * @see `Map#updateIn`
     */
    updateIn(keyPath: any[], updater: (value: any) => any): List<T>
    updateIn(keyPath: any[], notSetValue: any, updater: (value: any) => any): List<T>
     ...
     * @see `Map#mergeIn`
     */
    mergeIn(keyPath: Iterable<any, any>, ...iterables: Array<Iterable.Indexed<T>>): List<T>
    mergeIn(keyPath: any[], ...iterables: Array<Iterable.Indexed<T>>): List<T>
    mergeIn(keyPath: any[], ...iterables: T[][]): List<T>

    /**
     * @see `Map#mergeDeepIn`
     */
    mergeDeepIn(keyPath: Iterable<any, any>, ...iterables: Array<Iterable.Indexed<T>>): List<T>
    mergeDeepIn(keyPath: any[], ...iterables: Array<Iterable.Indexed<T>>): List<T>
    mergeDeepIn(keyPath: any[], ...iterables: T[][]): List<T>
  ...
  export function Map<K, V>(iter: Iterable<any, /* [K,V]*/ any[]>): Map<K, V>
  export function Map<K, V>(array: any[][]): Map<K, V>
  export function Map<V>(obj: Record<string, V>): Map<string, V>
  export function Map<K, V>(iterator: Iterator</* [K,V]*/ any[]>): Map<K, V>
  ...
  export interface Map<K, V> extends Collection.Keyed<K, V> {
    ...
    merge(...iterables: Array<Record<string, V>>): Map<string, V>
    ...
    mergeWith(
      merger: (previous?: V, next?: V, key?: K) => V,
      ...iterables: Array<Record<string, V>>
    ): Map<string, V>
    ...
    mergeDeep(...iterables: Array<Record<string, V>>): Map<string, V>
     ...
     *
     */
    updateIn(keyPath: any[], updater: (value: any) => any): Map<K, V>
    updateIn(keyPath: any[], notSetValue: any, updater: (value: any) => any): Map<K, V>
     ...
     *
     */
    mergeIn(keyPath: Iterable<any, any>, ...iterables: Array<Iterable<K, V>>): Map<K, V>
    mergeIn(keyPath: any[], ...iterables: Array<Iterable<K, V>>): Map<K, V>
    mergeIn(keyPath: any[], ...iterables: Array<Record<string, V>>): Map<string, V>
     ...
     *
     */
    mergeDeepIn(keyPath: Iterable<any, any>, ...iterables: Array<Iterable<K, V>>): Map<K, V>
    mergeDeepIn(keyPath: any[], ...iterables: Array<Iterable<K, V>>): Map<K, V>
    mergeDeepIn(keyPath: any[], ...iterables: Array<Record<string, V>>): Map<string, V>
  ...
  export function OrderedMap<K, V>(iter: Iterable<any, /* [K,V]*/ any[]>): OrderedMap<K, V>
  export function OrderedMap<K, V>(array: any[][]): OrderedMap<K, V>
  export function OrderedMap<V>(obj: Record<string, V>): OrderedMap<string, V>
  export function OrderedMap<K, V>(iterator: Iterator</* [K,V]*/ any[]>): OrderedMap<K, V>
  ...
  export namespace Set {
    ...
    function fromKeys(obj: Record<string, any>): Set<string>
  }
  ...
  export interface Set<T> extends Collection.Set<T> {
     ...
     * @alias merge
     */
    union(...iterables: Array<Iterable<any, T>>): Set<T>
    union(...iterables: T[][]): Set<T>
    merge(...iterables: Array<Iterable<any, T>>): Set<T>
     ...
     * within `iterables`.
     */
    intersect(...iterables: Array<Iterable<any, T>>): Set<T>
    intersect(...iterables: T[][]): Set<T>

    /**
     * Returns a Set excluding any values contained within `iterables`.
     */
    subtract(...iterables: Array<Iterable<any, T>>): Set<T>
  ...
  export namespace OrderedSet {
    ...
    function fromKeys(obj: Record<string, any>): OrderedSet<string>
  }
  ...
  export namespace Record {
    interface Class {
      new (): Map<string, any>
      new (values: Record<string, any>): Map<string, any>
      new (values: Iterable<string, any>): Map<string, any> // deprecated

      (): Map<string, any>
      (values: Record<string, any>): Map<string, any>
      (values: Iterable<string, any>): Map<string, any> // deprecated
    }
  }

  export function Record(defaultValues: Record<string, any>, name?: string): Record.Class
  ...
  export namespace Seq {
     ...
     */
    function of<T>(...values: T[]): Indexed<T>
     ...
     */
    export function Keyed<K, V>(): Keyed<K, V>
    export function Keyed<K, V>(seq: Iterable.Keyed<K, V>): Keyed<K, V>
    export function Keyed<K, V>(seq: Iterable<any, /* [K,V]*/ any>): Keyed<K, V>
    export function Keyed<K, V>(array: any[]): Keyed<K, V>
    export function Keyed<V>(obj: Record<string, V>): Keyed<string, V>
    export function Keyed<K, V>(iterator: Iterator</* [K,V]*/ any>): Keyed<K, V>
    export function Keyed<K, V>(iterable: /* Iterable<[K,V]>*/ Object): Keyed<K, V>

    export interface Keyed<K, V> extends Seq<K, V>, Iterable.Keyed<K, V> {
      /**
       * Returns itself
       */
      toSeq(): /* this*/ Keyed<K, V>
    }
     ...
     */
    export function Indexed<T>(): Indexed<T>
    export function Indexed<T>(seq: Iterable.Indexed<T>): Indexed<T>
    export function Indexed<T>(seq: Iterable.Set<T>): Indexed<T>
    export function Indexed<K, V>(seq: Iterable.Keyed<K, V>): Indexed</* [K,V]*/ any>
    export function Indexed<T>(array: T[]): Indexed<T>
    export function Indexed<T>(iterator: Iterator<T>): Indexed<T>
    export function Indexed<T>(iterable: /* Iterable<T>*/ Object): Indexed<T>

    export interface Indexed<T> extends Seq<number, T>, Iterable.Indexed<T> {
      /**
       * Returns itself
       */
      toSeq(): /* this*/ Indexed<T>
    }
     ...
     */
    export function Set<T>(): Set<T>
    export function Set<T>(seq: Iterable.Set<T>): Set<T>
    export function Set<T>(seq: Iterable.Indexed<T>): Set<T>
    export function Set<K, V>(seq: Iterable.Keyed<K, V>): Set</* [K,V]*/ any>
    export function Set<T>(array: T[]): Set<T>
    export function Set<T>(iterator: Iterator<T>): Set<T>
    export function Set<T>(iterable: /* Iterable<T>*/ Object): Set<T>
  ...
  export function Seq<V>(obj: Record<string, V>): Seq.Keyed<string, V>
  ...
  export namespace Iterable {
     ...
     */
    export function Keyed<K, V>(iter: Keyed<K, V>): Keyed<K, V>
    export function Keyed<K, V>(iter: Iterable<any, /* [K,V]*/ any>): Keyed<K, V>
    export function Keyed<K, V>(array: any[]): Keyed<K, V>
    export function Keyed<V>(obj: Record<string, V>): Keyed<string, V>
    export function Keyed<K, V>(iterator: Iterator</* [K,V]*/ any>): Keyed<K, V>
    export function Keyed<K, V>(iterable: /* Iterable<[K,V]>*/ Object): Keyed<K, V>
    ...
    export interface Keyed<K, V> extends Iterable<K, V> {
       ...
       */
      mapKeys<M>(
        mapper: (key?: K, value?: V, iter?: /* this*/ Keyed<K, V>) => M,
        context?: any,
      ): /* this*/ Keyed<M, V>
       ...
       */
      findKey(
        predicate: (value?: V, key?: K, iter?: /* this*/ Keyed<K, V>) => boolean,
        context?: any,
      ): K
     ...
     */
    export function Indexed<T>(iter: Indexed<T>): Indexed<T>
    export function Indexed<T>(iter: Set<T>): Indexed<T>
    export function Indexed<K, V>(iter: Keyed<K, V>): Indexed</* [K,V]*/ any>
    export function Indexed<T>(array: T[]): Indexed<T>
    export function Indexed<T>(iterator: Iterator<T>): Indexed<T>
    export function Indexed<T>(iterable: /* Iterable<T>*/ Object): Indexed<T>
    ...
    export interface Indexed<T> extends Iterable<number, T> {
       ...
       * in this Iterable.
       */
      interpose(separator: T): /* this*/ Indexed<T>
       ...
       *     // Seq [ 1, 'A', 'X', 2, 'B', 'Y' ]
       */
      interleave(...iterables: Array<Iterable<any, T>>): /* this*/ Indexed<T>
       ...
       *
       */
      zip(...iterables: Array<Iterable<any, any>>): /* this*/ Indexed<any>
      ...
      zipWith<Z>(zipper: (...any: any[]) => Z, ...iterables: Array<Iterable<any, any>>): Indexed<Z>
       ...
       */
      findIndex(
        predicate: (value?: T, index?: number, iter?: /* this*/ Indexed<T>) => boolean,
        context?: any,
      ): number
     ...
     */
    export function Set<T>(iter: Set<T>): Set<T>
    export function Set<T>(iter: Indexed<T>): Set<T>
    export function Set<K, V>(iter: Keyed<K, V>): Set</* [K,V]*/ any>
    export function Set<T>(array: T[]): Set<T>
    export function Set<T>(iterator: Iterator<T>): Set<T>
    export function Set<T>(iterable: /* Iterable<T>*/ Object): Set<T>
  ...
  export function Iterable<V>(obj: Record<string, V>): Iterable.Keyed<string, V>
